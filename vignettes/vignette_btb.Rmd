...
head(pts_density)
smooth_density <- btb_smooth(pts = pts_density,sEPSG = 2154,iBandwidth = 60000,iCellSize = 10000)
head(smooth_density)
...
head(pts_meanprice)
smooth_density <- btb_smooth(pts = pts_meanprice,sEPSG = 2154,iBandwidth = 60000,iCellSize = 10000)
head(smooth_density)
...
smooth_reunion <- btb_smooth(sfreunion,iCellSize = 500,iBandwidth = 2000)
...
```{r neighboors}
smooth_reunion <- btb_smooth(sfreunion,iCellSize = 500,iBandwidth = 2000, iNeighbor = 0)
smooth_reunion <- smooth_reunion %>% mutate(prop_poors = 100 * phouhold / houhold)
